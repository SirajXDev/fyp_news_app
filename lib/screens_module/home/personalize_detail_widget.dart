...
class PersonaliseNewsDetailsScreenWidget extends StatelessWidget {
  PersonaliseNewsDetailsScreenWidget({
    super.key,
    required this.personalizeNewsModel,
  });
  CreateNewsAdminModel personalizeNewsModel;

  @override
  Widget build(BuildContext context) {
    double width = MediaQuery.of(context).size.width;
    double height = MediaQuery.of(context).size.height;
    // DateTime dateTime = DateTime.parse(personalizeNewsModel.publishedAt! as String);
    var timeStamp = personalizeNewsModel.publishedAt?.toDate();
    String timeAgo = timeStamp?.timeAgo() ?? '';
      ...
      child: Scaffold(
              ...
              child: GestureDetector(
                onTap: () async {
                  ...
                  await ShareHelper.shareLink(
                      url: '${personalizeNewsModel.image}', title: '${personalizeNewsModel.title}');
              ...
              SizedBox(
                ...
                child: ClipRRect(
                  ...
                  child: CachedNetworkImage(
                    imageUrl: personalizeNewsModel.image ?? '',
                    fit: BoxFit.cover,
                ...
                child: ListView(
                  children: [
                    ...
                    TitleTextThemeWidget(
                      title: personalizeNewsModel.title!,
                      size: 16,
                    ),
                    SizedBox(height: height * 0.02),
                    SubTilesNewsSourceWidget(
                      source: personalizeNewsModel.source,
                      author: personalizeNewsModel.author,
                      timeAgo: timeAgo,
                    ),
                    SizedBox(
                      height: height * 0.01,
                    ...
                    BodyTextThemeWidget(
                      title: personalizeNewsModel.desc ?? '',
                      shrinkWrap: true,
                    ...
                    //   // url: headLines.url!,
                    //   onTap: () => launchUrl(Uri.parse('${personalizeNewsModel.image}')),
                    // ),
                    // SizedBox(
                    //   height: height * 0.04,
                    // ),
        ...
        floatingActionButton: FloatingActionButton(
          onPressed: () {
           ...
           var timeStamp = personalizeNewsModel.publishedAt;
          var publishedAtt = timeStamp?.toDate().toIso8601String();
            final bookMark = BookMarkHive()
              ..urlToImage = personalizeNewsModel.image
              ..title = personalizeNewsModel.title
              ..description = personalizeNewsModel.desc
              ..author = personalizeNewsModel.author
              ..source = personalizeNewsModel.source
          ...
          child: CustomIconWidget(
            icon: context.watch<BookmarkBloc>().state.bookMarkList.any(
                    (bookmark) => bookmark.title == personalizeNewsModel.title)
